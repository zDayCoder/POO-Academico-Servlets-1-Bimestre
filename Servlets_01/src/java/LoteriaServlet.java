 ...
 * @author ryana
 */
@WebServlet(urlPatterns = {"/loteria.html"})
public class LoteriaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>LoteriaServlet</title>");
            ...
            out.println("<h1>Hora de ficar chei das grana</h1>");
            out.println("<hr>");
            out.println("<table class='table-dark' border='1'>");
            out.println("<tr>");
            out.println("<th scope='row' class='p-3'> Quantidade </th><th scope='row' class='p-3'> Números </th></tr>");
            Random random = new Random();
            for (int i = 1; i <= 6; i++) {
                out.println("<tr>");
                out.println("<th scope='row' class='p-3'> " + i + " </th>");
                int rand = random.nextInt(59) + 1;                
                out.println("<td class='p-3'> " + rand + " </td>");
                out.println("</tr>");
            }
            out.println("</table>");
